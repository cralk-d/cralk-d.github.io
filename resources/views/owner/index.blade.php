        ...
        <aside class="main-sidebar sidebar-dark-success elevation-1">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/storage/owner/hh5YWa4YJ0PR5Bd0XG3v6eYQRO0IdYb9m2A3jTch.jpeg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                    <a href="/owner/setting/1/edit" class="d-block">MBABAZI Jacques</a>
                    </div>
                </div>
                <nav class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success">
                                ...
                                <a href="/owner/users/" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-warning">
                                ...
                                <a href="/owner/lists/" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            ...
                            <a href="/owner/feeds/" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
          <!-- ./col -->
        </div>
