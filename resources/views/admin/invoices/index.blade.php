                                ...
                                @foreach($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td> @if ($invoice->status== 0)
                                                <button class="btn btn-warning"><i class="fas fa-question-circle"></i> Pending</button>
                                            @endif
                                            @if ($invoice->status == 1)
                                                <button class="btn btn-success"><i class="fas fa-check-circle"></i> Completed</button> 
                                            @endif
                                            @if ($invoice->status == 2)
                                            <button class="btn btn-danger"><i class="fas fa-times-circle"></i> Cancelled</button> 
                                            @endif
                                        </td>
                                        <td>
